                                ...
                                if($classes != 'NO'){ ?>
                                  <?php foreach($classes as $class){?>
                                    <tr>
                                        ...
                                        <td><a target = "_blank" class="btn btn-block btn-link" href="<?php echo base_url();?>teacher_dashboard/form9/<?php echo $class->class_id?>"><button class="btn" style="background-color: #2F4F4F; color:white">Report Card </button></a></td>
                                    </tr> 
                                  <?php }?>
                                <?}else { ?>
