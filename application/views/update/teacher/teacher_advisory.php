                                ...
                                if($classes != 'NO'){ ?>
                                  <?php foreach($classes as $class){?>
                                    <tr>
                                        ...
                                        <td><a target = "_blank" class="btn btn-block btn-link" href="<?php echo base_url();?>teacher_dashboard/form5/<?php echo $class->class_id?>"><button class="btn" style="background-color: #f8313a; color:white">Form 5</button></a></td>
                                        <td><a target = "_blank" class="btn btn-block btn-link" href="<?php echo base_url();?>teacher_dashboard/form6/<?php echo $class->class_id?>"><button class="btn" style="background-color: #f62705; color:white">Form 6</button></a></td>
                                        <td><a target = "_blank" class="btn btn-block btn-link" href="<?php echo base_url();?>teacher_dashboard/all_subject_final_grade/<?php echo $class->class_id?>/1"><button class="btn" style="background-color: #b198dc; color:white">Subject <?php echo $class->class_id?></button></a></td>
                                    </tr> 
                                  <?php }?>
                                <?}else { ?>
