                                ...
                                if($classes != 'NO'){ ?>
                                  <?php foreach($classes as $class){?>
                                    <tr>
                                        ...
                                        <td><a target = "_blank" class="btn btn-block btn-link" href="<?php echo base_url();?>teacher_dashboard/all_subject_final_grade/<?php echo $class->class_id?>/1/<?php echo $sy_id?$sy_id:''; ?>"><button class="btn" style="background-color: #b198dc; color:white">Subject <?php echo $class->class_id?></button></a></td>
                                    </tr> 
                                  <?php }?>
                                <?}else { ?>
